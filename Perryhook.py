...
# Checks the length of the username input and if its over 80 it alerts u because in normal Discord without nitro that wouldn't work and usernames thru webhooks cant have nitro so it limits to 80 characters and simply closes/exits the program.
    if len(username) > 80:
        print(
...
# Checks the length of the message input and if its over 2000 it alerts u because in normal Discord without nitro that wouldn't work and sending messages thru webhooks cant have nitro so it limits to 2000 characters and simply closes/exits the program.
    if len(message) > 2000:
        print(
